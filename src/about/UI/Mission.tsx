        ...
        <section className="mt-12 border-[1px] border-solid border-black bg-zorvanz-blue">
            <div className="border-[1px] border-solid border-zorvanz-blue m-8 flex flex-col justify-center items-center bg-white lg:h-[70vh] lg:flex-row">
                ...
                <header className="m-20 flex flex-col justify-center items-center text-start gap-4">
                    ...
                    <p className="text-xl w-[20ch] lg:w-[40ch]">Queremos ser un líder en la industria de las fragancias, ofreciendo productos que se enfocan en darle bienestar a los usuarios. Se enfocan en crear aromas que no solo agraden a los sentidos, sino que también promuevan el bienestar de los usuarios, buscando inspirar amor y lealtad en cada experiencia con sus fragancias.</p>
                </header>
            </div>
