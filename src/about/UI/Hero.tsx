...
export default function Hero() {
    return (
        <section className="flex flex-col justify-center items-center lg:flex-row lg:h-screen">
            <header className="w-full pt-20 px-6 flex flex-col justify-center items-center m-8 gap-4 lg:w-1/3 lg:p-30">
                <h1 className="pb-4 text-4xl lg:ml-[-3rem]">Nuestra Historia</h1>
                <p className="text-xl w-[20ch] lg:w-[40ch]">
